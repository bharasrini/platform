...
async function test_validateEmailAddress()
{
    ...
    common.statusMessage(fn, "Set2: Email: ", email2, ", Is valid email: ", is_valid2);
...
async function test_matchWithinXPercent()
{
    ...
    common.statusMessage(fn, "Set 2: Num1: ", num1_2, ", Num2: ", num2_2, ", Percent: ", percent_2, ", Is within: ", is_within_2);
...
async function test_checkType()
{
    ...
    common.statusMessage(fn, "Set 2: Value: ", object_value, ", Is type: ", is_type_2);

    const date_value = new Date();
    const is_type_3 = common.checkType(date_value);
    common.statusMessage(fn, "Set 3: Value: ", date_value, ", Is type: ", is_type_3);
...
async function test_sameStringSet()
{
    ...
    common.statusMessage(fn, "Set 3: ", set3, ", Set 4: ", set4, ", Are same sets: ", are_same_2);
...
async function test_levDistance()
{
    ...
    common.statusMessage(fn, "String 1: ", str3, ", String 2: ", str4, ", Levenshtein Distance: ", distance2);
