...
async function test_copyFileOnGoogleDrive()
{
    ...
    const copied_file_url = await common.copyFileOnGoogleDrive(source_file_url, dest_folder_id, file_name_to_use, copy_if_same_file_exists);
...
async function test_trashFileOnGoogleDrive()
{
    ...
    const result = await common.trashFileOnGoogleDrive(folder_id, file_name);
...
async function test_moveFolderOnGoogleDrive()
{
    ...
    const result = await common.moveFolderOnGoogleDrive(folder_id, dest_folder_id);
