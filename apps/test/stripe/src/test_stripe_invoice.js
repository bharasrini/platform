...
async function test_create_coupon()
{
    ...
    const fn = test_create_coupon.name;
    ...
    if(coupon_code1 == "")
    {
        common.statusMessage(fn, "Failed to create Stripe coupon with type: ", discount_type1, " and discount: ", discount_1);
    }
    else
    {
        common.statusMessage(fn, "Successfully created Stripe coupon: ", coupon_code1, " with type: ", discount_type1, " and discount: ", discount_1);
    }
    ...
    if(coupon_code2 == "")
    {
        common.statusMessage(fn, "Failed to create Stripe coupon with type: ", discount_type2, " and discount: ", discount_2);
    }
    else
    {
        common.statusMessage(fn, "Successfully created Stripe coupon: ", coupon_code2, " with type: ", discount_type2, " and discount: ", discount_2);
    }
...
{
    // Get the function name for logging
    const fn = test_create_invoice_item.name;
    ...
    if(invoice_item == "")
    {
        common.statusMessage(fn, "Failed to create Stripe invoice item with type: ", discount_type, " and discount: ", discount);
    }
    else
    {
        common.statusMessage(fn, "Successfully created Stripe invoice item: ", invoice_item, " with type: ", discount_type, " and discount: ", discount);
    }
...
{
    // Get the function name for logging
    const fn = test_create_invoice.name;

    common.start_test(fn);

    // First create the invoice item
    const invoice_item = await test_create_invoice_item();
    ...
    if(invoice_id == "")
    {
        common.statusMessage(fn, "Failed to create Stripe invoice for customer: ", customer_id);
    }
    else
    {
        common.statusMessage(fn, "Successfully created Stripe invoice: ", invoice_id, " for customer: ", customer_id);
    }
...
async function test_stripe_invoice()
{
    ...
    const fn = test_stripe_invoice.name;
