...
async function test_fd_get_companies()
{
    ...
    const _fn = test_fd_get_companies.name;
    ...
    common.statusMessage(_fn, "Companies read successfully !!!. Number of companies read: ", company.num_companies);
...
{
    // Get the function name for logging
    const _fn = test_fd_createNewCompany.name;
    ...
    common.statusMessage(_fn, "Company created successfully with following details: ", company_details);
...
{
    // Get the function name for logging
    const _fn = test_fd_updateCompanyName.name;
    ...
    common.statusMessage(_fn, "Company name updated successfully !!!. Updated data: ", data);
...
{
    // Get the function name for logging
    const _fn = test_fd_updateCSM.name;
    ...
    common.statusMessage(_fn, "CSM updated successfully !!!. Updated data: ", data);
...
{
    // Get the function name for logging
    const _fn = test_fd_updateAccountTier.name;
    ...
    common.statusMessage(_fn, "Account tier updated successfully !!!. Updated data: ", data);
...
{
    // Get the function name for logging
    const _fn = test_fd_updateAccountDomains.name;
    ...
    common.statusMessage(_fn, "Account domains updated successfully !!!. Updated data: ", data);
...
{
    // Get the function name for logging
    const _fn = test_fd_updateAccountARR.name;
    ...
    common.statusMessage(_fn, "Account ARR updated successfully !!!. Updated data: ", data);
...
{
    // Get the function name for logging
    const _fn = test_fd_updateAccountSource.name;
    ...
    common.statusMessage(_fn, "Account Source updated successfully !!!. Updated data: ", data);
...
{
    // Get the function name for logging
    const _fn = test_fd_updateAccountPartner.name;
    ...
    common.statusMessage(_fn, "Account Partner updated successfully !!!. Updated data: ", data);
...
{
    // Get the function name for logging
    const _fn = test_fd_company.name;
